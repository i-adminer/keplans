...
const TrendingCard = () => {
  return (
    <div className="w-72 overflow-hidden rounded-tl-2xl rounded-br-2xl bg-background shadow-lg cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-[1.02] relative group">
      {/* IMAGE SECTION */}
